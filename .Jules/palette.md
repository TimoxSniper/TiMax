...
**Action:** Always use dynamic ARIA labels for buttons that toggle between two states, ensuring they describe the *result* of clicking the button (e.g., "Close menu" when the menu is already open).
