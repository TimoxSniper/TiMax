...
export const metadata: Metadata = {
  ...
  description:
    "Widerrufsbelehrung für Verbraucher - 14-tägiges Widerrufsrecht bei timax. Muster-Widerrufsformular und Fristen.",
  alternates: {
    canonical: "/widerruf",
  },
  openGraph: {
          ...
          <section className="text-foreground space-y-12 font-sans text-base leading-relaxed lg:text-lg">
            <div className="border-border border-t pt-8">
              ...
              <p className="mb-4">
                ...
                können dafür auch das beigefügte Muster-Widerrufsformular verwenden, das jedoch
            ...
            <div className="border-border border-t pt-8">
              ...
              <p className="mb-4">
                ...
                Inhalten, wenn timax mit der Ausführung des Vertrags begonnen hat und Sie
                ausdrücklich zugestimmt haben, dass timax mit der Ausführung des Vertrags vor Ablauf
                der Widerrufsfrist beginnt und Sie Ihre Kenntnis davon bestätigt haben, dass Sie
                durch Ihre Zustimmung mit Beginn der Ausführung des Vertrags Ihr Widerrufsrecht
                verlieren.
              </p>
              <p>
                Das bedeutet: Wenn Sie unseren Service bereits genutzt haben (z.B. Transkription
                oder Textgenerierung durchgeführt wurde), erlischt das Widerrufsrecht, da es sich um
                eine bereits erbrachte digitale Dienstleistung handelt.
              </p>
            </div>
            ...
            <div className="border-border border-t pt-8">
              ...
              <div className="mb-4 rounded-lg bg-black/5 p-6 dark:bg-white/5">
                <p className="mb-4">
                  (Wenn Sie den Vertrag widerrufen wollen, dann füllen Sie bitte dieses Formular aus
                  und senden Sie es zurück.)
                </p>
                <p className="mb-2">An: timax, [Anschrift], E-Mail: info@timax.app</p>
                <p className="mb-4">
                  Hiermit widerrufe(n) ich/wir (*) den von mir/uns (*) abgeschlossenen Vertrag über
                  den Kauf der folgenden Waren (*)/ die Erbringung der folgenden Dienstleistung (*)
                </p>
                <p className="mb-2">Bestellt am (*)/erhalten am (*): _________________</p>
                <p className="mb-2">Name des/der Verbraucher(s): _________________</p>
                <p className="mb-2">Anschrift des/der Verbraucher(s): _________________</p>
                <p className="mb-2">
                  Unterschrift des/der Verbraucher(s) (nur bei Mitteilung auf Papier):
                  _________________
                </p>
                <p className="mb-2">Datum: _________________</p>
                <p className="mt-4 text-sm">(*) Unzutreffendes streichen.</p>
              </div>
            </div>
