        ...
        <AnimatedSection delay={200} direction="up">
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="group border-2 border-gray-300 dark:border-gray-600 bg-transparent text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 hover:border-gray-400 dark:hover:border-gray-500 hover:text-gray-900 dark:hover:text-gray-100 rounded-xl px-8 py-6 text-base font-medium"
              asChild
            >
              <Link href="/chat">
